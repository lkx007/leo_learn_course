        ...
        for path in files:
            ...
            if kind == "md":
                ...
                if "E2课程" in path.replace("\\", "/"):
                    e2_href = "e2.html?v=prog1" if online else "site/e2.html"
                    body += (
...
<body>
  <header class="hero">
    ...
    <div class="hero-btns">
      <a class="btn btn-primary" href="e2.html?v=prog1">🏆 E2 积木比赛复习</a>
  ...
  <div class="path e2-banner">
    ...
    <p style="margin-top:14px"><a class="btn btn-primary" href="e2.html?v=prog1">🐟 打开能听能点的复习课</a>
  ...
  <section class="section tools-section">
    <h2>快捷入口</h2>
    <div class="hero-btns">
      <a class="btn btn-primary" href="e2.html?v=prog1">🏆 E2 复习课</a>
